...
async function autoMarkNotChecked() {
  ...
  const startOfDay = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 8, 35, 0);
  const endOfDay = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 8, 45, 0);
